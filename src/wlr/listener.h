...
DECLARE_LISTENERS(wlr_cursor, (axis)(button)(frame)(hold_begin)(hold_end)(motion_absolute)(motion)(pinch_begin)(pinch_end)(pinch_update));
DECLARE_LISTENERS(wlr_cursor_shape_manager_v1, (destroy)(request_set_shape));
DECLARE_LISTENERS(wlr_cursor, (swipe_begin)(swipe_end)(swipe_update)(tablet_tool_axis)(tablet_tool_button)(tablet_tool_proximity)(tablet_tool_tip)(touch_cancel)(touch_down)(touch_frame)(touch_motion)(touch_up));
...
DECLARE_LISTENERS(wlr_drag, (destroy)(drop)(focus));
DECLARE_LISTENERS(wlr_drag_icon, (destroy));
DECLARE_LISTENERS(wlr_drag, (motion));
...
DECLARE_LISTENERS(wlr_ext_image_capture_source_v1, (constraints_update));
DECLARE_LISTENERS(wlr_ext_image_capture_source_v1_cursor, (update));
DECLARE_LISTENERS(wlr_ext_image_capture_source_v1, (destroy)(frame));
...
DECLARE_LISTENERS(wlr_keyboard, (keymap)(key)(modifiers)(repeat_info));
...
DECLARE_LISTENERS(wlr_output, (bind)(commit)(damage)(description)(destroy)(frame));
...
DECLARE_LISTENERS(wlr_output, (needs_frame));
DECLARE_LISTENERS(wlr_output_power_manager_v1, (destroy)(set_mode));
DECLARE_LISTENERS(wlr_output, (precommit)(present)(request_state));
DECLARE_LISTENERS(wlr_pointer, (axis)(button));
...
DECLARE_LISTENERS(wlr_pointer, (frame));
DECLARE_LISTENERS(wlr_pointer_gestures_v1, (destroy));
DECLARE_LISTENERS(wlr_pointer, (hold_begin)(hold_end)(motion_absolute)(motion)(pinch_begin)(pinch_end)(pinch_update)(swipe_begin)(swipe_end)(swipe_update));
...
DECLARE_LISTENERS(wlr_seat, (destroy)(keyboard_grab_begin)(keyboard_grab_end));
DECLARE_LISTENERS(wlr_seat_keyboard_state, (focus_change));
DECLARE_LISTENERS(wlr_seat, (pointer_grab_begin)(pointer_grab_end));
DECLARE_LISTENERS(wlr_seat_pointer_state, (focus_change));
DECLARE_LISTENERS(wlr_seat, (request_set_cursor)(request_set_primary_selection)(request_set_selection)(request_start_drag)(set_primary_selection)(set_selection)(start_drag)(touch_grab_begin)(touch_grab_end));
DECLARE_LISTENERS(wlr_security_context_manager_v1, (commit)(destroy));
DECLARE_LISTENERS(wlr_server_decoration, (destroy));
DECLARE_LISTENERS(wlr_server_decoration_manager, (destroy)(new_decoration));
DECLARE_LISTENERS(wlr_server_decoration, (mode));
...
DECLARE_LISTENERS(wlr_touch, (cancel)(down)(frame)(motion));
DECLARE_LISTENERS(wlr_touch_point, (destroy));
DECLARE_LISTENERS(wlr_touch, (up));
...
DECLARE_LISTENERS(wlr_xdg_toplevel, (destroy));
DECLARE_LISTENERS(wlr_xdg_toplevel_icon_manager_v1, (destroy)(set_icon));
DECLARE_LISTENERS(wlr_xdg_toplevel, (request_fullscreen)(request_maximize)(request_minimize)(request_move)(request_resize)(request_show_window_menu)(set_app_id)(set_parent)(set_title));
